...
The EDII TN RAMP Survey application is designed to digitize the traditional survey process. Instead of maintaining paper-based records, survey data can be collected and managed through a clean, mobile-friendly web application.
...
*  Dashboard displaying survey statistics
*  Survey history and submitted records
